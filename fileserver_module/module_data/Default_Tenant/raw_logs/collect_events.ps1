...
# Target: Event IDs 4624, 4625, 4648, 4656, 4658, 4660, 4663, 4688, 4698, 5140, 5145, 7045, 1102 from the last 100 day(s)
# ====================================================================

$ErrorActionPreference = 'SilentlyContinue'

# Time filter: last 100 day(s)
...
Write-Host "[+] Da xu ly xong $($ParsedEvents.Count) events." -ForegroundColor Green
        ...
        $ParsedEvents | ConvertTo-Json -Depth 5 | Out-File -FilePath 'C:\Users\laptopJP.vn\Desktop\APT_project-thanh (1)\APT_project-thanh\fileserver_module\module_data\Default_Tenant\raw_logs\collected_20260323_012451.json' -Encoding UTF8
        Write-Host "[+] Da xuat ra JSON: C:\Users\laptopJP.vn\Desktop\APT_project-thanh (1)\APT_project-thanh\fileserver_module\module_data\Default_Tenant\raw_logs\collected_20260323_012451.json" -ForegroundColor Green
