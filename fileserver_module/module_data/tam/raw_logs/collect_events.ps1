...
# Target: Event IDs 4624, 4625, 4648, 4656, 4658, 4660, 4663, 4688, 4698, 5140, 5145, 7045, 1102 from the last 7 day(s)
# ====================================================================

$ErrorActionPreference = 'SilentlyContinue'

# Time filter: last 7 day(s)
...
Write-Host "[+] Da xu ly xong $($ParsedEvents.Count) events." -ForegroundColor Green
        ...
        $ParsedEvents | ConvertTo-Json -Depth 5 | Out-File -FilePath 'D:\PycharmProjects\APT\Version1-0\fileserver_module\module_data\tam\raw_logs\collected_20260326_100724.json' -Encoding UTF8
        Write-Host "[+] Da xuat ra JSON: D:\PycharmProjects\APT\Version1-0\fileserver_module\module_data\tam\raw_logs\collected_20260326_100724.json" -ForegroundColor Green
