...
Write-Host "[+] Da xu ly xong $($ParsedEvents.Count) events." -ForegroundColor Green
        ...
        $ParsedEvents | ConvertTo-Json -Depth 5 | Out-File -FilePath 'C:\Users\laptopJP.vn\Desktop\APT_project-thanh (1)\APT_project-thanh\fileserver_module\collected_logs.json' -Encoding UTF8
        Write-Host "[+] Da xuat ra JSON: C:\Users\laptopJP.vn\Desktop\APT_project-thanh (1)\APT_project-thanh\fileserver_module\collected_logs.json" -ForegroundColor Green
